...
Let me先看一下你现有的列表教材，以便匹配风格和深度。

Viewed Python%20%E5%AE%B9%E5%99%A8%E5%9F%BA%E7%A1%80%E6%80%BB%E8%AE%BA%283-5%29.md:1-800

好的，我已经了解了你的教材风格。现在让我继续看完列表教材的剩余部分，以便完整匹配风格。

Viewed Python%20%E5%AE%B9%E5%99%A8%E5%9F%BA%E7%A1%80%E6%80%BB%E8%AE%BA%283-5%29.md:800-1073

好的，我已经完全掌握了你的教材风格。现在开始输出关于**元组、集合、字典**的详细教程。由于内容量非常大，我会分多次输出，请耐心阅读。
...
# 3. 线程安全
# 不可变对象天生是线程安全的，多个线程可以同时读取同一个元组而不需要加锁
```
...
好的，由于单次输出有长度限制，我继续从上次中断处输出。以下是接续内容：
...
```python
# ❌ 性能差：对大列表做 in 测试
valid_ids = [101, 102, 103, ...]   # 假设有上万条
if user_id in valid_ids:           # O(n)，慢
    pass

# ✅ 正确做法：转为集合
valid_ids = {101, 102, 103, ...}   # set
